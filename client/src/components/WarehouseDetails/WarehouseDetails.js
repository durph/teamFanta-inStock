        ...
        <main className="warehouse-details">
          <div className="warehouse-details__header">
            <Link to="/warehouse" className="warehouse-details__header-back">
              <img src={back_arrow} alt="back arrow" className="warehouse-details__header-back-img" />
            </Link>
          ...
          <section className="warehouse-details__info">
            <ul className="warehouse-details__info-list">
              ...
              <li className="warehouse-details__info-list-item">{address.street}</li>
              <li className="warehouse-details__info-list-item">{address.suiteNum}</li>
              <li className="warehouse-details__info-list-item">{address.city}, {address.province}</li>
              <li className="warehouse-details__info-list-item">{address.postal}</li>
            </ul>
            <ul className="warehouse-details__info-list">
              <li className="warehouse-details__info-list-label">Contact</li>
              <li className="warehouse-details__info-list-item">{contact.name}</li>
              <li className="warehouse-details__info-list-item">{contact.title}</li>
              <li className="warehouse-details__info-list-item">{contact.phone}</li>
              <li className="warehouse-details__info-list-item">{contact.email}</li>
            </ul>
          </section>
