        ...
        return(
            <section className="inventory">
                <div className="inventory__header">
                    ...
                    <input type="text" className="inventory__header-search" placeholder="search" />
                ...
                <div className="inventory__list-container">
                    ...
                    <Link className="inventory__list-link" to='id'>
                        <ul className="inventory__list-entry">
                            ...
                            <li className="inventory__list-entry-item-product">Product Name here</li>
                            <li className="inventory__list-entry-item-description">Here is a very brief...</li>
